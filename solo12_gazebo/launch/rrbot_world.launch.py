...
def generate_launch_description():
    ...
    solo12_gazebo = os.path.join(
        get_package_share_directory('solo12_gazebo'),
        'worlds',
        'rrbot.world')
    ...
    gazebo = IncludeLaunchDescription(
                ...
                launch_arguments={'world': solo12_gazebo}.items(),
             )
    ...
    xacro_file = os.path.join(rrbot_description_path,
                              'urdf',
                              'rrbot.urdf.xacro')
    vbm_hw_3_path = os.path.join(get_package_share_directory('solo12_description'))
    ...
    robot_controllers = os.path.join(get_package_share_directory("solo12_gazebo"),"config","gazebo_controllers.yaml")
